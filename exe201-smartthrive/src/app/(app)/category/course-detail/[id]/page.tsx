        ...
        course && (
            ...
            Online
                        ...
                        <div className="w-full mt-4 flex justify-center items-center">
                            ...
                            >
                                <div className="">
                                    Add to package
                                    <div
                                        className=" bg-slate-200 opacity-100 shadow-lg z-50 text-black absolute py-3 w-[95%]  top-12 left-2 packageList invisible ">
                                        Select your package
                                                ...
                                                ? studentXPackage.map((item) => (
                                                    ...
                                                    >
                                                        <div className="text-xs flex justify-between">
                                                            ...
                                                            <div
                                                                className="line absolute h-[1px] w-0 bg-black mt-2 transition-all group-hover:w-full top-6"></div>
                                                        </div>
                                                    </div>
                                                ))
                                                : ""}
                        ...
                        <div className="w-full mt-2 flex justify-center items-center">
                            <button
                                className="button bg-transparent px-20 py-3 text-base font-bold text-black rounded-full border-2 border-black w-full">
                                Buy now
                            </button>
                        </div>
                        ...
                        <div className="text-black font-semibold text-base ">
                            ...
                            <div className="flex mt-4">
                                ...
                                />
                                <div
                                    className="button bg-slate-700 text-white text-base font-semibold py-2 px-4 hover:opacity-80 hover:cursor-pointer">
                                    Apply
                                </div>
                            </div>
                        </div>
                ...
                <div className="flex px-36 gap-4">
                    <div
                        className="button py-3 px-6 font-semibold text-sm border border-black text-black capitalize rounded-full hover:bg-slate-400 hover:cursor-pointer">
                        {subject}
                    </div>
