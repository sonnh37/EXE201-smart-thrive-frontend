            ...
            {selectedPackage != null && studentXPackage.length != 0 && (
                <div className="flex gap-28 px-24 text-black w-full">
                    <div className="w-[75%] mb-2">
                        <div
                            className=" font-semibold opacity-85 w-full border-b-[1px] border-slate-500 pb-2 flex gap-4">
                            <div>
                    ...
                    <div className="w-[25%]">
                        ...
                        <div className="flex mt-4">
                            ...
                            />
                            <div
                                className="button bg-purple-600 text-white text-base font-semibold py-2 px-4 hover:opacity-80 hover:cursor-pointer">
                                Apply
                            </div>
                        </div>
