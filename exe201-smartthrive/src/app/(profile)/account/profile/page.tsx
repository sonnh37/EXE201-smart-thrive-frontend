      ...
      <section className="relative flex-shrink-0 mb-0">
        ...
        <section className="relative py-14 bg-blueGray-200 ">
          <div className="container mx-auto px-14">
            <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-xl rounded-lg -mt-40 "> {/* Giảm giá trị mt-64 thành mt-40 */}
              <div className="px-4">
              ...
              <div className="flex flex-wrap">
                ...
                <div className="w-full lg:w-12/12 px-4">
                  <div className="relative w-full mb-3">
                    ...
                    <input type="text" className="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" value={user?.phone} />
                  </div>
                </div>
