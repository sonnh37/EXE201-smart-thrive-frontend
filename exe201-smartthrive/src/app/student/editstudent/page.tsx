    ...
    <form className='w-2/3 bg-white p-4 py-3  '>
      <div className="space-y-12">
        <div className="border-b border-gray-900/10 pb-12">
          <h2 className=" font-semibold leading-7 text-gray-900 text-2xl">Profile</h2>
          ...
          <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            ...
            <div className="col-span-full">
              ...
              <p className="mt-3 text-xl leading-6 text-gray-600">Write a few sentences about yourself.</p>
            </div>

            <div className="col-span-full">
              <label htmlFor="photo" className="block text-2xl font-medium leading-6 text-gray-900">
                Photo
              </label>
               {/* Image element */}
...
<div className='w-full flex items-start justify-center'>
    ...
    <select
        ...
        defaultValue="img1"
    >
        <option value="img1" className="text-black">Chọn ảnh 1</option>
        <option value="img2" className="text-black">Chọn ảnh 2</option>
        <option value="img3" className="text-black">Chọn ảnh 3</option>
        <option value="img4" className="text-black">Chọn ảnh 4</option>
        <option value="img5" className="text-black">Chọn ảnh 5</option>
    </select>
</div>
            </div>
        ...
        <div className="border-b border-gray-900/10 pb-12">
          ...
          <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            ...
            <div className="sm:col-span-2">
              <label htmlFor="region" className="block text-xl font-medium leading-6 text-gray-900">
                State / Province
              </label>
              <div className="mt-2">
                <input
