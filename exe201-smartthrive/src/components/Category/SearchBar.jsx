            ...
            <div className="box rounded-xl border border-gray-300 bg-white p-6 w-full md:max-w-sm">
              ...
              <div className="flex items-center mb-5 gap-1">
                <div className="relative w-full">
                  ...
                  <select className="h-12 border border-gray-300 text-gray-900 text-xs font-medium rounded-full block w-full py-2.5 px-4 appearance-none relative focus:outline-none bg-white">
              ...
              <button className="w-full py-2.5 flex items-center justify-center gap-2 rounded-full bg-indigo-600 text-white font-semibold text-xs shadow-sm shadow-transparent transition-all duration-500 hover:bg-indigo-700 hover:shadow-indigo-200 mt-4 ">
                <svg
                  width="17"
                  height="16"
                  viewBox="0 0 17 16"
