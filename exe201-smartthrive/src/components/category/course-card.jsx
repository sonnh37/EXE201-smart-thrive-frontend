        ...
        <div key={id} className="flex justify-center items-center mb-8 px-4">
            <div className="mx-auto h-full w-[20vw]">
                <div
                    ...
                    <div
                        className="relative mx-4 mt-4 overflow-hidden text-gray-700 bg-white bg-clip-border rounded-xl h-60">
                    ...
                    <div className="p-6">
                        ...
                        {(method == 0) | (method == 2) ? (
                            <div
                                className="block opacity-90 w-[90%] text-ellipsis  mt-2 font-sans text-sm antialiased font-medium leading-[1.5em] h-[6vh] overflow-hidden text-blue-gray-900">
                                {describe}
                            </div>
                        ) : method == 1 ? (
