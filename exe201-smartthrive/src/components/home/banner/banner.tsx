...
const Banner = () => {
  ...
  return (
    <div className="w-full h-[85vh] bg-[url('/banner-background.svg')] scale-105 bg-[105%_85%,0_0] mt-24 bg-repeat-x bg-cover relative">
      <div className=" oswald-text font-bold text-[3.5rem] text-black w-full text-center absolute top-[20%] left-5">
