    ...
    return (
        <div className="w-full h-full " id="banner">
            <div className="w-full">
                ...
                <div
                    className="line bg-black opacity-70  w-[2px] h-[8.5rem] absolute top-[22rem] left-[8.5rem] bannerText">
                    <span/>
                </div>
          ...
          Learn Now!
                ...
                <span
                    className="inline-block animate-bounce rounded-full p-4 top-[36rem] left-[47vw] text-black text-sm absolute bannerText">
