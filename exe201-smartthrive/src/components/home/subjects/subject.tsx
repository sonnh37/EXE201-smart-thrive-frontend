...
const SubjectList = () => {
  return (
    <div className="w-full h-full py-24  text-black justify-center bg-[#FAF5FF]">
      <div className="text-lg font-bold px-32 bg-gradient-to-r from-blue-600 via-green-500 to-indigo-400 inline-block text-transparent bg-clip-text w-full  h-full text-center">
        Chủ đề phổ biến
      </div>
