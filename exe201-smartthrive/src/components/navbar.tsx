                    ...
                    <li className="container-nav flex min-w-fit text-center">
                        ...
                        >
                            <div className="relative">
                                Home
                                <span
                                    className="absolute line w-0 h-[1px] bg-black top-7 left-0 group-hover:w-full transition-all duration-300"></span>
                            </div>
                        </Link>
                                        ...
                                        >
                                            {list.subLv1.map((subLv1) => (
                                                <div key={subLv1.name} className="navItemLv1">
                                                    ...
                                                    <div
                                                        className="navLv2 absolute top-0 left-[16.8rem] bg-white shadow-xl transition-all duration-300 translate-y-36 invisible opacity-0 min-w-[18vw] min-h-[95vh]">
                                                        <div
                                                            className="min-h-12 flex items-center opacity-70 text-left px-4 ">
                                                            Popular topics
                                                        </div>
